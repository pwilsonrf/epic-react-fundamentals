...
* The DOM (or document object model) represents the structure of the documents and contents of a website.
The browser then exposes the DOM to Javascript so you can interact with it to add a layer of interactivity to your web-page.
